...
namespace dotup.Binding
{
	public static class SafeFireAndForgetExtensions
	{
		...
		public static void SafeFireAndForget<TException>(this Task task, in bool continueOnCapturedContext = false, in Action<TException> onException = null) where TException : Exception
		{
			HandleSafeFireAndForget(task, continueOnCapturedContext, onException);
		}
